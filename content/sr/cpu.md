...
La CPU (Central Processing Unit - unità centrale di elaborazione) rappresenta il "cervello" di un calcolatore in quanto esegue le **istruzioni** che compongono un programma. Tali istruzioni sono solitamente molto semplice come: sommare due numeri, memorizzare un numero in memoria, leggere un carattere dalla tastiera, ... 
...
* Altri registri e circuiti per [accedere alla memoria](ram.html) e all'I/O.

Nella figura sotto, si vede uno schema di una CPU contenente le varie parti sopra elencate.
{% include_relative img/cpu_schema.html %}
...
{% include_relative img/cpu_fetch_esempio.html %}
</div>
<div class="col-6" markdown="1">
<h5 class="no_toc">Esempio di fetch</h5>
...
<div class="row">
<div class="col-6" markdown="1">
{% include_relative img/cpu_decode_esempio.html %}
</div>
<div class="col-6" markdown="1">
<h5 class="no_toc">Esempio di decodifica</h5>
...
<div class="row">
<div class="col-6" markdown="1">
{% include_relative img/cpu_operands_esempio.html %}
</div>
<div class="col-6" markdown="1">
<h5 class="no_toc">Esempio di operand fetch</h5>
...
<div class="row">
<div class="col-6" markdown="1">
{% include_relative img/cpu_execute_esempio.html %}
</div>
<div class="col-6" markdown="1">
<h5 class="no_toc">Esempio di execute</h5>
...
<div class="row">
<div class="col-6" markdown="1">
{% include_relative img/cpu_write_esempio.html %}
</div>
<div class="col-6" markdown="1">
<h5 class="no_toc">Esempio di scrittura del risultato</h5>
...
* [Una CPU a 8 bit fatta in Minecraft](https://www.youtube.com/watch?v=ydd6l3iYOZE)