...
<div className="p-2 bg-white rounded-2xl shadow-lg dark:shadow-gray-500 mb-2">
![Architettura di una Web Application](/img/inf/inf-web-development.svg)
<div className="flex justify-center font-base font-thin text-gray-800">Architettura di una Web Application</div>
</div>
